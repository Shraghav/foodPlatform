...
const jwtParse = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // decode token
    try {
        const decoded = jsonwebtoken_1.default.decode(token); //got token and decoded
        const auth0Id = decoded.sub;
        const user = yield user_1.default.findOne({ auth0Id }); //search auth0id
        if (!user) {
            return res.sendStatus(401);
        }
        //appending info about user
        req.auth0Id = auth0Id; //they are just strings
